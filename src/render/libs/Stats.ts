...
class Stats {
  ...
  constructor(name: string = 'Stats') {
    ...
    this.dom.style.cssText = `position:fixed;top:${
      numStats * 70
    }px;left:0;cursor:pointer;opacity:0.9;z-index:90000`;
    this.mode = 0;
  ...
  public update(
    ...
    if (this.context) {
      ...
      this.context.fillText(
        this.statName + value.toFixed(this.precision) + ' ' + this.name,
        this.TEXT_X,
        this.TEXT_Y
      );
