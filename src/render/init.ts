...
import CameraController from './controllers/character-controller';
...
import { initDebugInfo, setupDebugGui, useDebug } from './debug/debug.js';
// @ts-ignore
import { GUI } from './libs/lil-gui.module.min.js';
import Encoder from './passes/Encoder.js';
import { CameraStruct } from './utils/structs.js';
...
let stats: Stats,
  ...
  renderer: Renderer,
  camera: PerspectiveCamera = new PerspectiveCamera(50, 0, 0.1, 1000),
...
export const initEngine = async () => {
  ...
  camera.quaternion.setFromAxisAngle(new Vector3(0, 1, 0), Math.PI / 2.5);
